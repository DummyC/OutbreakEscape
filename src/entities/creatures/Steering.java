...
public class Steering {
    ...
    public Vector2D obstacleAvoidance() {
        ...
        Obstacle obstacle = findObstacle();
    ...
    private boolean collision(Vector2D ahead, Vector2D ahead2, Vector2D zombiePos, Obstacle obstacle) {
    ...
    private Obstacle findObstacle() {
        ...
        for (int i = 0; i < player.getWorld().getObstacles().size(); i++) {
            Obstacle o = (Obstacle) player.getWorld().getObstacles().get(i);
